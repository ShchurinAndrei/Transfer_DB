...
# полученные в предыдущем шаге csv-файлы переносим в БД MySQL, создавая или дополняя ранее созданные одноименные таблицы
...
Data_Tables = []
Flag = True
# variables for connect to Postgre
Database = '****'
User = '****'
Password = '****'
Host = '****'
Port = '5432'
Table_Name = 'test_token_view_table'
...
if Flag:
    # цикл по перебору строк подключения из txt-файла (токен, витрина, таблица)
